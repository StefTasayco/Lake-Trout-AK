...
# daily_growth <- scen1_output_clean |>
#   ggplot() +
#   aes(x = Day, y = Weight.g, color = Run_name) +
#   geom_line() +
#   scale_color_manual(values = my_paired13) +
#   labs(
#     y = "Weight (g)",
#     color = "Age of fish",
#     title = "Year-long Lake Trout Growth by Age"
#   ) +
#   theme(
...
2.  I believe the model could not calculate the growth of some runs because their final weight (he weight at the next older age) was a lot lower than their starting weight. Model might not understand why the fish lost so much weight in one year.
